...
from dsbox.template.library import DefaultClassificationTemplate, DefaultRegressionTemplate, DoesNotMatchTemplate2, DefaultLinkPredictionTemplate
...
t = DefaultLinkPredictionTemplate()
# t = DefaultClassificationTemplate()
